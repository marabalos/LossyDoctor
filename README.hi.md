...
> **नोट:** यह अनुवाद AI द्वारा तैयार किया गया है।
...
इसी कारण **किसी lossy फ़ाइल को कभी भी master source, preservation format या interchange format के रूप में उपयोग नहीं करना चाहिए**। उसे किसी दूसरे lossy फ़ॉर्मैट में दोबारा encode करने से केवल एक और पीढ़ी की हानि जुड़ती है। उसे केवल lossless फ़ॉर्मैट में बदलने से फ़ाइल का आकार बढ़ता है; पहले से खोया हुआ डेटा वापस नहीं आता।
...
यदि यह संभव नहीं है, लेकिन वास्तविक रूप से recover किए जा सकने वाले PCM को ठीक-ठीक सिद्ध किया जा सकता है, तो LossyDoctor उसे **lossless FLAC** के रूप में सुरक्षित कर सकता है। परिणामस्वरूप फ़ाइल बड़ी होगी, लेकिन उसमें कोई नई हानि नहीं जोड़ी जाएगी: वह ठीक वही recovered PCM एक playable और preservation के लिए उपयुक्त फ़ॉर्मैट में सुरक्षित रखेगी।
...
- मूल compressed bitstream के preservation को हमेशा प्राथमिकता देता है।
...
- हर problematic फ़ाइल को स्वतः FLAC में नहीं बदलता: lossless recovery केवल तब preservation विकल्प है जब मूल bitstream को सही रूप से सुरक्षित रखना संभव न हो।
...
जब एक ही सुरक्षित repair मौजूद हो, LossyDoctor उसे लागू कर सकता है। जब bitstream को सुरक्षित नहीं रखा जा सकता लेकिन genuine PCM को सिद्ध किया जा सकता है, तो वह बिना किसी नई हानि के उस ऑडियो को सुरक्षित कर सकता है। जब दोनों में से कुछ भी सिद्ध नहीं किया जा सकता, तो वह damage report करता है और कोई काल्पनिक solution नहीं बनाता।
...
## पूरी प्रक्रिया के लिए एक ही टूल

आम तौर पर इस्तेमाल किए जाने वाले ऑडियो सत्यापन टूल कई संरचनात्मक या डिकोडिंग समस्याओं का पता लगा सकते हैं, लेकिन वे प्रायः किसी विशेष फ़ंक्शन, फ़ॉर्मेट या प्रक्रिया के किसी एक चरण पर केंद्रित होते हैं। **LossyDoctor का उद्देश्य इस पूरे काम को एक ही टूल में केंद्रीकृत करना है**: यह सामान्य जाँचों के साथ अतिरिक्त सत्यापन भी करता है, यह निर्धारित करता है कि किसी विसंगति को सुरक्षित रूप से सुधारा जा सकता है या नहीं, केवल स्पष्ट रूप से समर्थित प्रक्रिया उपलब्ध होने पर ही मरम्मत करता है, परिणाम का वस्तुनिष्ठ सत्यापन करता है और मूल फ़ाइल को हमेशा अपरिवर्तित सुरक्षित रखता है। जब प्रत्यक्ष मरम्मत संभव नहीं होती, लेकिन ऑडियो सामग्री को विश्वसनीय रूप से पुनर्प्राप्त किया जा सकता है, तो उसे lossless फ़ॉर्मेट में पुनर्प्राप्त करने का विकल्प भी उपलब्ध है। उद्देश्य यह है कि उपयोगकर्ता इन मामलों का ऑडिट, निदान और समाधान एक ही सुसंगत कार्यप्रवाह में कर सके, बिना एक ही लक्ष्य पूरा करने के लिए कई अलग-अलग टूल और प्रक्रियाओं का सहारा लिए।
