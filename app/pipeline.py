...
def analyze_file(path:Path,cfg:dict,root:Path,ffmpeg:str,ffprobe_exe:str,mpg123_exe:str|None=None,mpg123_trust:str="PINNED_SHA256"):
    ...
    if a.detected_codec=='opus' and ident.get('ogg_opus'):
        ...
        if not fragmented_presentation and presentation.get('determined') and presentation_decode.get('completed') and presentation.get('presentation_sample_count') is not None and presentation_decode.get('sample_frames')!=presentation.get('presentation_sample_count'):
